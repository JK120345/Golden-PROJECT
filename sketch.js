...
function preload()
{
  ...
  fish2_img = loadAnimation("on1.png","on2.png");

  en = loadAnimation("oshell.png","cshell.png");
...
function setup() {
 ...
 Sophia=createSprite(100,500,0.23,0.23);
...
pearl=createSprite(1300,130,15,15);
 pearl.addAnimation("prl",en);
 pearl.scale=0.3;
  
//  l=createSprite(1300,130,15,15);
//  l.addAnimation("dv",en);
//  l.scale=0.3;
//  l.visible=false;

 fishhr=createSprite(140,180,15,15);
 fishhr.addAnimation("fsh",fish1_img);
 fishhr.scale=0.5;
 fishhr.velocityX=3;

 fishob=createSprite(1050,120,15,15);
 fishob.addAnimation("fush",fish2_img);
 fishob.scale=0.5;
 fishob.velocityY=3;
...
//   shl3.scale=0.12;
  ...
  wall2=createSprite(940,290,20,20);
  wall2.addImage(weed_img);
  wall2.scale=0.2;

  
  
   wall4=createSprite(580,340,20,20);
  //wall4.shapeColor="blue";
  wall4.addImage(weed_img);
  wall4.scale=0.2;

   walll4=createSprite(570,480,20,20);
  
  walll4.addImage(weed_img);
  walll4.scale=0.2;
  
  wall5=createSprite(220,320,20,20);
  ...
  // wall5l.scale=0.3;
   ...
   wall1=createSprite(180,90,20,20);
  wall1.addImage(weed_imgh);
  wall1.scale=0.18;

  //wall1.debug=true;

  wall3=createSprite(400,90,20,20);
  wall3.addImage(weed_imgh);
  wall3.scale=0.18;

 
   wall5ll=createSprite(60,180,20,20);
  ...
  //  wall02.scale=0.3;
   ...
   wall01=createSprite(1050,600,20,20);
   wall01.addImage(weed_imgh);
   wall01.scale=0.18;
  
   wall12=createSprite(610,95,20,20);
  wall12.addImage(weed_imgh);
  wall12.scale=0.16;
 
 wall5l6l=createSprite(130,590,20,20);
  wall5l6l.addImage(weed_imgh);
 wall5l6l.scale=0.18;
 
 wall5l7l=createSprite(340,595,20,20);
  wall5l7l.addImage(weed_imgh);
 wall5l7l.scale=0.16;

 wall7=createSprite(520,590,20,20);
  wall7.addImage(weed_imgh);
  wall7.scale=0.15;
 
  wall007=createSprite(300,270,20,20);
...
//  wall5l8l.scale=0.2;
 ...
 wall06=createSprite(1160,340,20,20);
...
//  wall006.scale=0.25;
 ...
 wall07=createSprite(1160,500,20,20);
  wall07.addImage(weed_img);
 wall07.scale=0.25;
 
 wall08=createSprite(870,370,20,20);
...
wall08.scale=0.11;
  ...
  wall8=createSprite(290,400,20,20);
  wall8.addImage(weed_imgh);
  wall8.scale=0.12;
 
  wall008=createSprite(1090,70,20,20);
  wall008.addImage(weed_imgh);
  wall008.scale=0.19;
  
  wall0008=createSprite(720,540,20,20);
  wall0008.addImage(weed_imgh);
  wall0008.scale=0.19;
  
  wall9=createSprite(950,135,20,20);
...
if(fishhr.isTouching(wall9)){
  fishhr.velocityX=-4;
}
if(fishhr.isTouching(wall5ll)){
  fishhr.velocityX=4;
}

if(fishob.isTouching(wall008)){
  fishob.velocityY=4;
}
if(fishob.isTouching(wall01)){
  fishob.velocityY=-4;
}

// if(Sophia.isTouching(pearl)){
//  l.visible=true;
// }

if(Sophia.isTouching(fishhr)){
  Sophia.x=100;
  Sophia.y=500;
}
if(Sophia.isTouching(fishob)){
  Sophia.x=100;
  Sophia.y=500;
}
if(keyDown(UP_ARROW)){
